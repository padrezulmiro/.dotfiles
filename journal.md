...
## 21 Jul 25
Added plenty of more packages to the playbook so I'm getting to the point where I'm only missing the most difficult ones, `doom-emacs` and a neovim distro. Memo: `starship` can be installed using a `-y` flag!
